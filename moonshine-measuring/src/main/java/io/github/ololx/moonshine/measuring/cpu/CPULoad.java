 ...
 * {@link #compareTo(CPULoad)}, the result will be:
 * <ul>
 *     <li>
 ...
 */
public final class CPULoad implements Comparable<CPULoad> {
     ...
     */
    private CPULoad(long processorTime) {
     ...
     */
    private CPULoad(long processorTime, long intervalTime) {
        this.processorTime = processorTime;
     ...
     */
    public static CPULoad ofProcessorNano(long processorTime) {
        return new CPULoad(processorTime, DEFAULT_INTERVAL_NANO);
    }
     ...
     * bytes
     */
    public static CPULoad ofProcessorNano(long processorTime, long intervalTime) {
        return new CPULoad(processorTime, intervalTime);
    }
     ...
     */
    @Override
    public int compareTo(CPULoad other) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof CPULoad) {
            CPULoad other = (CPULoad) obj;
