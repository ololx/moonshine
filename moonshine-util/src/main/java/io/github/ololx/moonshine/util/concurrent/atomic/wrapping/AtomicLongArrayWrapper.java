 ...
 */
public class AtomicLongArrayWrapper implements AtomicArrayWrapper<Long> {
     ...
     */
    public AtomicLongArrayWrapper(int length) {
     ...
     */
    public AtomicLongArrayWrapper(long[] array) {
