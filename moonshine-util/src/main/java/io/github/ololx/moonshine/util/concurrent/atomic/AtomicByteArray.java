...
import io.github.moonshine.unsafe.adapter.AtomicByteArrayHandle;
 ...
 *     It uses underlying memory access provided by {@link AtomicByteArrayHandle}.
...
public class AtomicByteArray {
     ...
     */
    private static final AtomicByteArrayHandle byteArrayAtomicAccess = new AtomicByteArrayHandle();
     ...
     *
     * @see AtomicByteArrayHandle#putVolatile(byte[], int, byte)
     *
     *     <p><strong>Example usage:</strong></p>
     *     <pre>{@code
     *             AtomicByteArray byteArray = new AtomicByteArray(new byte[]{1, 2, 3, 4, 5});
     ...
     *
     * @see AtomicByteArrayHandle#getAndSet(byte[], int, byte)
     *
     *     <p><strong>Example usage:</strong></p>
     *     <pre>{@code
     *             AtomicByteArray byteArray = new AtomicByteArray(new byte[]{1, 2, 3, 4, 5});
     ...
     *     expected value.
     *
     * @see AtomicByteArrayHandle#compareAndSwap(byte[], int, byte, byte)
     *
     *     <p><strong>Example usage:</strong></p>
     *     <pre>{@code
     *             AtomicByteArray byteArray = new AtomicByteArray(new byte[]{1, 2, 3, 4, 5});
     ...
     *
     * @see AtomicByteArrayHandle#getVolatile(byte[], int)
     *
     *     <p><strong>Example usage:</strong></p>
     *     <pre>{@code
     *             AtomicByteArray byteArray = new AtomicByteArray(new byte[]{10, 20, 30, 40, 50});
