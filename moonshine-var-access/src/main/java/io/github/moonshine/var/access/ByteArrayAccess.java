...
public final class ByteArrayAccess implements VarAccess {
     ...
     *
     * @implSpec This method uses {@link MemoryAccess#updateAndGetByte(Object, long, ByteUnaryFunction)}
     *     for atomic updates.
     * @see MemoryAccess#updateAndGetByte(Object, long, ByteUnaryFunction)
     *
     *     <p><strong>Example usage:</strong></p>
     *     <pre>{@code
     *         ByteArrayAccess byteArray = new ByteArrayAccess();
     ...
     *
     * @implSpec This method uses
     *     {@link MemoryAccess#accumulateAndGetByte(Object, long, byte, ByteBinaryFunction)}
     *     for atomic accumulation.
     *
     *     <p><strong>Example usage:</strong></p>
     *     <pre>{@code
     ...
     *         }</pre>
     * @see MemoryAccess#accumulateAndGetByte(Object, long, byte, ByteBinaryFunction)
     */
