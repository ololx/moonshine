 ...
 */
public class ZonedDateTimeEncoderTest {
    ...
    public void encode_whenEncodeValue_thenEncodedBytesEqualsExpectedBytes(ZonedDateTime value,
                                                                           ByteIndexOperator byteOrder,
                                                                           byte[] expected) {
        //Given
        // value bytes encoder and origin value
        ValueBytesEncoder<ZonedDateTime> encoder = new ZonedDateTimeEncoder();
