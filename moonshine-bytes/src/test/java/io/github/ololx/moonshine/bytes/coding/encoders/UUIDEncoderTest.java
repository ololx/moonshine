...
import io.github.ololx.moonshine.bytes.coding.decoders.UUIDDecoder;
...
public class UUIDEncoderTest {
    ...
    public void encode_whenEncodeValue_thenEncodedBytesEqualsExpectedBytes() {
        ...
        byte[] encodedValue = encoder.encode(randomUUID, ByteIndexOperator.identity());
        UUID decodedValue = decoder.decode(encodedValue, ByteIndexOperator.identity());
        ...
        assertEquals(randomUUID, decodedValue);
    }
}
