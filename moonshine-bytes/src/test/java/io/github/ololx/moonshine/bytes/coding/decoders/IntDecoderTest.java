 ...
 */
public class IntDecoderTest extends Value32BitDecoderTest {

    @Test(dataProvider = "providesValueAndEndianness")
    public void decode_whenDecodeValue_thenDecodedBytesEqualsExpectedBytes(int expected,
                                                                           ByteIndexOperator byteOrder,
                                                                           byte[] value) {
        //Given
        // int decoder and origin value
