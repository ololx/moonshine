 ...
 */
public class LongEncoder implements ValueBytesEncoder<Long> {

    /**
     * Encodes a given value to a byte array using the specified endianness
     * starting at the specified offset.
     *
     * @param value      the value type {@code Long} to be encoded
     ...
     */
    @Override
    public byte[] encode(Long value, int offset, ByteIndexOperator endianness) {
