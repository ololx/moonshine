...
/**
 * The decoder that converts byte arrays to a {@code Long} value.
 *
 * project moonshine
 ...
 */
public class LongDecoder implements ValueBytesDecoder<Long> {
     ...
     */
    @Override
    public Long decode(byte[] bytes, int offset, ByteIndexOperator endianness) {
        return ValueBytesDecoder.value64BitDecoder()
